      ...
      <div className="h-[600vh]">
        <div className="sticky top-20 min-h-[calc(100vh-5rem)] flex flex-col justify-center bg-white py-2 md:py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            {/* Redesigned Header: Subtle Editorial Style */}
                    ...
                    <div className="space-y-4 lg:space-y-10">
                      <div className="space-y-3 lg:space-y-6">
                        <div className="flex items-center gap-3">
                          <span className="px-4 py-1.5 bg-indigo-600 text-white rounded-full text-[10px] font-black uppercase tracking-[0.2em] font-mono shadow-lg shadow-indigo-100">
                            Step {steps[activeStep].id}: {steps[activeStep].label}
                          </span>
                        </div>
                        <h3 className="text-4xl sm:text-6xl lg:text-8xl font-black text-slate-900 font-display tracking-tight leading-[1.05]">
